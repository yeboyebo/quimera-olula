...
import { FactoryEcofricalia } from "./factory.ts";
...
const App = () => {
  ...
  FactoryObj.setMenu(
    crearMenu(
      new FactoryEcofricalia() as unknown as Record<string, MenuContextFactory>
    )
  );
  FactoryObj.setApp(
    new FactoryEcofricalia() as unknown as Record<
      string,
