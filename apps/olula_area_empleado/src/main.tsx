...
import { FactoryAreaEmpleados } from "./factory.ts";
...
const App = () => {
    ...
    FactoryObj.setMenu(
        crearMenu(
            new FactoryAreaEmpleados() as unknown as Record<string, MenuContextFactory>
        )
    );
    FactoryObj.setApp(
        new FactoryAreaEmpleados() as unknown as Record<string, Record<string, unknown>>
    );
