        ...
        <div className="columna-unica">
          ...
          <div className="fila-3">
            <QInput
              ...
              {...uiProps("responsable_local")}
            />
            <QInput
              label="Responsable orquesta"
              {...uiProps("responsable_orquesta")}
            />
            <QInput
              label="Responsable producciones"
              {...uiProps("responsable_producciones")}
            />
          </div>
