...
function Login({ onLogin, useStyles, ...props }) {
  ...
  const isGuest = user?.user === 'guest' ? true : false;
  const showLogin = isGuest ? true : (!autenticando && !autenticado) ? true : false
  console.log("autenticando && !autenticado", autenticando, autenticado, isGuest);
