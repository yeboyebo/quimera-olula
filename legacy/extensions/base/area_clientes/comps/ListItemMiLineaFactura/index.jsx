...
function ListItemMiLineaFactura({ selected = false, funPrimaryLeft, funPrimaryRight, hideSecondary = false, model, modelName, ...props }) {
...
export default ListItemMiLineaFactura;
