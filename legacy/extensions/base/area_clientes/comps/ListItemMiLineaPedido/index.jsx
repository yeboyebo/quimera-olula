...
function ListItemMiLineaPedido({ selected = false, funPrimaryLeft, funPrimaryRight, hideSecondary = false, model, modelName, ...props }) {
        ...
        secondary={
          !hideSecondary && (
            <Box width={1} mt={0.5} display="flex" justifyContent="space-between">
              <Box display="inline">
                <Typography component="span" variant="body2" color="textPrimary">{`${linea.referencia ? linea.referencia : ""
                  }`}</Typography>
              </Box>
              <Box display="inline">
...
export default ListItemMiLineaPedido;
