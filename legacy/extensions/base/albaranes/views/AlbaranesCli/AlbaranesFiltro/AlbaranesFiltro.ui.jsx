...
function AlbaranesFiltro() {
  const [{ filtroVisible }, dispatch] = useStateValue();

  return (
    <Quimera.Template id="AlbaranesFiltro">
      <FilterBox id="albaranes.filter" schema={getSchemas().albaranescli} open={filtroVisible}>
...
export default AlbaranesFiltro;
