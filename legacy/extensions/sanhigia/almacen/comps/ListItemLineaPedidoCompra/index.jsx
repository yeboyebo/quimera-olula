...
function ListItemLineaPedidoCompra({ disabled, dispatch, linea, modalLotesAlmacenVisible, hideSecondary = false, callbackFocus, callbackCambiada, selected = false, ...props }) {
  ...
  // const dispLote = linea.dispLotesAlmacen.toFixed(2);
          ...
          <ListItemText
            ...
            primary={
              <Box width={1} display="flex" justifyContent="space-between">
                ...
                <Box display="inline">{`Cant. ${cant} / Recibir ${linea.shCantAlbaran || 0}`}</Box>
              </Box>
            }
            secondary={
              !hideSecondary && (
                <Box width={1} display="flex" justifyContent="space-between">
                  ...
                  <Box display="inline">
                    <Typography
                      ...
                      variant="body2"
                      color="textPrimary"
                    >{`Ref Prov ${linea.referenciaProv}`}</Typography>
                  </Box>
                  <Box display="inline">
                    <Typography
                      component="span"
                      variant="body2"
                      color="textPrimary"
                    >{`Ubic. ${linea.codUbicacionArticulo} / Serv. ${linea.totalEnAlbaran}`}</Typography>
                  </Box>
                </Box>
              )
            }
...
export default ListItemLineaPedidoCompra;
...
//   return equal;
// };
// export default React.memo(ListItemLineaPedidoCompra, equalProps);
