...
function ListItemPedidoCompra({ arrayMultiCheck = [], renderAvatar, renderId, model, modelName, selected = false, funSecondaryLeft, habilitarMulticheck = false, avatar = "P", ...props }) {
      ...
      <ListItemText
        ...
        primary={
          <Box width={1} display="flex" justifyContent="space-between">
            <Box display="inline">
              <Typography variant="body1">{pedido.nombre || ""}</Typography>
            </Box>
...
export default ListItemPedidoCompra;
