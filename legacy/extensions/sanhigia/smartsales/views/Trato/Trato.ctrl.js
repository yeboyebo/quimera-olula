...
export const bunch = parent => ({
  ...
  getCountDirCliente: [
    {
      ...
      success: "onGetCountDirClienteSucceeded",
    },
  ],
  onGetCountDirClienteSucceeded: [
    {
      type: "setStateKey",
      plug: ({ response }) => ({
        path: "trato.dirAuto",
  ...
  refreshCallback: [
    {
      condition: (_, { refreshCallback }) => !!refreshCallback,
      type: "function",
      function: (_, { refreshCallback }) => refreshCallback(),
    },
    {
      condition: (_, { refreshCallback }) => !refreshCallback,
      type: "grape",
  ...
  deletedCallback: [
    {
      condition: (_, { deletedCallback }) => !deletedCallback,
      type: "function",
    ...
    },
    {
      condition: (_, { deletedCallback }) => !!deletedCallback,
      type: "function",
      function: (_, { deletedCallback }) => deletedCallback(),
    },
  ],
