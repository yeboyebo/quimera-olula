...
function ListItemPedidoOtrosAgentes({ renderAvatar, model, modelName, selected = false, funSecondaryLeft, avatar = "P", ...props }) {
...
export default ListItemPedidoOtrosAgentes;
