...
export default {
  unidades: {
    name: "mx_colacosidointerno",
    key: "idunidad",
    fields:
      "idunidad,modelo,configuracion,estado,estadoant,pausada,idtelamantas,idtelacomp,idtela,fechaprevista",
    page: { limit: 40 },
    load: apiData => ({
    ...
    filter: () => ({
      and: [
        ...
        [
          "pr_unidadesproducto.estado",
          "not_in",
          ["'COSIDO'", "'MONTADO'", "'TERMINADO'", "'CARGADO'"],
        ],
      ],
    }),
