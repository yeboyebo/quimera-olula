...
function CosidoInternoMaster({ useStyles }) {
  ...
  return (
    <Quimera.Template id="CosidoInternoMaster">
              ...
              <ListItem
                ...
                className={
                  unidades.dict[idUnidad].pausada === "Si"
                    ? classes.pausada
                    : unidades.dict[idUnidad].estado === "CORTADO" ||
                      unidades.dict[idUnidad].estado === "PTE"
                    ? classes.pendiente
                    : classes.encurso
                }
                onClick={() =>
...
export default CosidoInternoMaster;
