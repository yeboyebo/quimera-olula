...
import { eventoStreamDesdeApi, normalizarRespuestaIa } from "#/asistente/dominio.ts";
import { A2uiClientAction, ConsultaIa, EventoStreamIa, RespuestaIa } from "#/asistente/diseño.ts";
