...
import { getLineasModulo, getModLin, patchModLin } from "../infraestructura.js";
import { ContextoDetalleModLin, EstadoDetalleModLin } from "./diseño.js";
...
export const refrescarLineas: ProcesarDetalle = async (contexto) => {
    const lineas = await getLineasModulo(contexto.modLin.id);
    return {
        ...contexto,
        lineas: {
            lista: lineas,
