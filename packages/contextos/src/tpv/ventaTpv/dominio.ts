...
import { borrarFactura, deleteLinea, deletePago, getLineas, getPagos, getVenta, patchDevolverVenta, patchFactura, patchLinea, postEmitirVale, postLinea, postLineaPorBarcode, postPago } from "./infraestructura.ts";
