...
import { EjemploCalendarioMovil } from "./ejemplos/EjemploCalendarioMovil.tsx";
import { EjemploCargaInfinita } from "./ejemplos/EjemploCargaInfinita.tsx";
import { EjemploModosMúltiples } from "./ejemplos/EjemploModosMúltiples.tsx";
import { EjemploNavegacionTeclado } from "./ejemplos/EjemploNavegacionTeclado.tsx";
import { EjemploPersonalizacionVisual } from "./ejemplos/EjemploPersonalizacionVisual.tsx";
import { EjemploSeleccionCalendario } from "./ejemplos/EjemploSeleccionCalendario.tsx";
...
const ejemplos: EjemploConfig[] = [
  {
    ...
    descripcion:
      "Selección simple, múltiple y por rangos con validaciones empresariales",
    icono: "📅",
  ...
  },
  {
    ...
    descripcion:
      "Control completo por teclado con atajos personalizados y accesibilidad",
    icono: "⌨️",
  ...
  },
  {
    ...
    descripcion:
      "Visualización del calendario en diferentes modos (día, semana, mes)",
    icono: "📊",
  ...
  },
  {
    ...
    descripcion:
      "Personalización visual del calendario con temas y colores personalizados",
    icono: "🎨",
...
export const CalendarioPlayground: React.FC<CalendarioPlaygroundProps> = ({
  ...
  const ejemplosFiltrados = ejemplos.filter((ejemplo) => {
    const coincideBusqueda =
      ...
      ejemplo.tags.some((tag) =>
        tag.toLowerCase().includes(busqueda.toLowerCase())
      );

    const coincifeCategoria =
      filtroCategoria === "todas" || ejemplo.categoria === filtroCategoria;
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderBottom: "1px solid #dee2e6",
                  backgroundColor: `${
                    categorias[ejemploSeleccionado!.categoria].color
                  }15`,
                  flexShrink: 0,
                }}
              >
      ...
      >
        ...
        <input
          ...
          placeholder={
            esMovilReal
              ? "🔍 Buscar..."
              : "🔍 Buscar ejemplos, funcionalidades, tags..."
          }
          value={busqueda}
          ...
          ejemplosFiltrados.map((ejemplo) => (
              ...
              style={{
                ...
                border: `2px solid ${
                  ejemploActivo === ejemplo.id
                    ? categorias[ejemplo.categoria].color
                    : "transparent"
                }`,
                backgroundColor:
                  ejemploActivo === ejemplo.id
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    fontSize: esMovilReal ? "1.6rem" : "1.6rem",
                    flexShrink: 0,
                  }}
                >
                  {" "}
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    >
                      {categorias[ejemplo.categoria].icono}{" "}
                      {categorias[ejemplo.categoria].titulo}
                    </span>
