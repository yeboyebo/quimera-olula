...
import { CabeceraCalendario } from "./CabeceraCalendario.tsx";
import { MenuAccionesMovil } from "./MenuAccionesMovil.tsx";
...
export const CabeceraGrid: React.FC<CabeceraGridProps> = ({
  ...
  const { izqModo = [], derModo = [], izqHoy = [], derHoy = [] } = botones;
  if (esMovil) {
    return (
