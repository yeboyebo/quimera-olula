...
export const getMetaTablaEvento = (onChange: (evento: Evento, valor: boolean) => void) => [
  ...
  { id: "descripcion", cabecera: "Nombre", tipo: "texto" as const, ancho: "200px", render: (e: Evento) => <span className="enlace-detalle" onClick={() => window.location.href = `/eventos/evento/${e.evento_id}`}><TextoConTooltip texto={e.descripcion} /></span> },
  { id: "fecha_inicio", cabecera: "Fecha", tipo: "texto" as const },
  { id: "lugar", cabecera: "Lugar", tipo: "texto" as const, render: (e: Evento) => <TextoConTooltip texto={e.lugar} /> },
  { id: "hora_inicio", cabecera: "Horario", tipo: "hora" as const, ancho: "80px" },
  { id: "nombre_cliente", cabecera: "P. Cliente", tipo: "texto" as const, ancho: "200px", render: (e: Evento) => <TextoConTooltip texto={e.nombre_cliente} /> },
  { id: "nombre_proveedor", cabecera: "P. Prov.", tipo: "texto" as const, ancho: "200px", render: (e: Evento) => <TextoConTooltip texto={e.nombre_proveedor} /> },
  { id: "nombre_empresa", cabecera: "Empresa fact.", tipo: "texto" as const, ancho: "200px", render: (e: Evento) => <TextoConTooltip texto={e.nombre_empresa} /> },
  ...["presupuesto", "enviado_a_cliente", "recibido_por_cliente", "enviado_a_proveedor", "recibido_por_proveedor", "factura_enviada", "hoja_ruta_hecha", "hoja_ruta_enviada", "altas_ss", "carteleria", "liquidacion"].map(campo => ({
    id: campo, cabecera: cabeceras[campo as keyof typeof cabeceras] || campo, tipo: "booleano" as const, ancho: "115px",
