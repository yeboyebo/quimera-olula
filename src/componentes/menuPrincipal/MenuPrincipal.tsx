...
// import { ElementoMenu, elementosDelMenu } from "../../contextos/comun/menu";
...
//   const [originalMenuItems, setOriginalMenuItems] = useState<ElementoMenu[]>(
//     []
//   );
//   const [menuItems, setMenuItems] = useState<ElementoMenu[]>([
//     ...elementosDelMenu,
//   ]);
...
//   const comprobarSiMostrarDesplegado = (item: ElementoMenu) => {
//     return (
//       menuItems.length == 1 ||
//       item.subMenuItems.filter((it: ElementoMenu) => {
